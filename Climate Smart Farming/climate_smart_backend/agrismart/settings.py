...
SECRET_KEY = config('SECRET_KEY', default='agrismart-dev-secret-key-change-in-production-xyz123')
...
CSRF_TRUSTED_ORIGINS = config(
    ...
    default='https://*.railway.app,https://*.vercel.app,http://localhost:5173',
    cast=Csv()
)
