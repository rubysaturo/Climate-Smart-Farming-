...
SECRET_KEY = config('SECRET_KEY', default='dev-only-not-for-production-CHANGE-ME')

DEBUG = config('DEBUG', default=True, cast=bool)

if not DEBUG and SECRET_KEY == 'dev-only-not-for-production-CHANGE-ME':
...
CSRF_TRUSTED_ORIGINS = config(
    ...
    default='https://*.railway.app,https://*.render.com,https://*.fly.dev,http://localhost:5173',
    cast=Csv()
)
