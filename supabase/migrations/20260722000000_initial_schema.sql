...
VALUES 
    ...
    (2, 'East Field - Trans Nzoia (Kwanza)', 'Kamau Agro Holdings', 'Maize', 32.5, 'Moderate (pH 5.9)', 'Normal', -0.312, 36.095, '[[-0.308, 36.090], [-0.308, 36.100], [-0.316, 36.100], [-0.316, 36.090]]'::jsonb),
